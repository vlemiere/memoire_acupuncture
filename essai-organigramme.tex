...
&\fbox{\begin{minipage}[t]{0.1\textwidth}\begin{center}Absence d'augmentation du débit et de la fréquence cardiaque\end{center} \end{minipage}}
&\fbox{\begin{minipage}[t]{0.1\textwidth}\begin{center}Absence d'augmentation de la volémie\end{center} \end{minipage}}
...
1&\fbox{\begin{minipage}[t]{0.1\textwidth}\begin{center}Vide de \textsc{sang}\end{center} \end{minipage}}
&3&4&\fbox{\begin{minipage}[t]{0.1\textwidth}\begin{center}Hypoperfusion placentaire\end{center} \end{minipage}}&6\\
    };
...
\draw[->] (tree-2-2) -- (tree-3-1) node [midway,below]{}; %{$(1-p)$};
\draw[->] (tree-2-2) -- (tree-3-2) node [midway,below]{}; %{$(1-p)$};
\draw[->] (tree-2-4) -- (tree-3-3) node [midway,below]{}; %{$(1-p)$};
\draw[->] (tree-2-4) -- (tree-3-4) node [midway,below]{}; %{$(1-p)$};
\draw[->] (tree-2-6) -- (tree-3-5) node [midway,below]{}; %{$(1-p)$};
\draw[->] (tree-2-6) -- (tree-3-6) node [midway,below]{}; %{$(1-p)$};

\draw[->] (tree-4-1) -- (tree-3-1) node [midway,below]{}; %{$(1-p)$};
\draw[->] (tree-4-1) -- (tree-3-2) node [midway,below]{}; %{$(1-p)$};

\draw[->] (tree-3-1) -- (tree-5-2) node [midway,below]{}; %{$(1-p)$};
\draw[->] (tree-3-2) -- (tree-5-2) node [midway,below]{}; %{$(1-p)$};
\draw[->] (tree-3-3) -- (tree-5-2) node [midway,below]{}; %{$(1-p)$};
\draw[->] (tree-3-4) -- (tree-5-5) node [midway,below]{}; %{$(1-p)$};
\draw[->] (tree-3-5) -- (tree-5-5) node [midway,below]{}; %{$(1-p)$};
